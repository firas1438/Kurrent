            ...
            {items.map((item, idx) => (
                ...
                >
                    <AnimatePresence>
                        {hoveredIndex === item.id && (
                            <motion.div
                                ...
                                className="absolute -top-16 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md bg-secondary px-4 py-2 text-xs shadow-xl"
                            >
                    ...
                    <img
                        ...
                        src={item.image}
                        alt={item.name}
                        className="relative m-0! size-10 rounded-full border border-secondary object-cover object-top p-0! transition duration-500 group-hover:z-30"
                    />
                </div>
            ))}
        </>
